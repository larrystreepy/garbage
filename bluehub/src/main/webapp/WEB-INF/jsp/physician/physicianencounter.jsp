...
<%-- <jsp:include page="../sidemenuadmin.jsp"></jsp:include> --%>
...
function fnClearMsgField() {
   ...
   function fnSetTimeout(id, time) {
	...
	function searchDateVisitRecordssss(){
...
<div class="content-body">
	...
	<div id="encounter" style="display: none">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label" for="typeahead-local">Encounter
			</label>
			<div class="col-sm-5">
				<div class="input-group input-group-in">
					<span class="input-group-addon text-silver"><i
						class="glyphicon glyphicon-user"></i></span>
					<textarea rows="5" cols="50" style="resize: none;" name="note"
						value="" id="note"></textarea>
				</div>
			</div>
		</div>
