...
<body class="animated fadeIn">
	<header class="header">
		<div class="header-brand">
			<a data-pjax=".content-body" href="<%=request.getContextPath()%>/"
				style=""> <img width="410px" height="60px" src="<%=request.getContextPath()%>/images/mybluehub.png" style="margin-left: -77px;"> </a>
		</div>
