...
<script>
	...
	function showDetais() {
		...
		if (mailid == "" && physicianid == "" && fax=="") {
			...
			document.getElementById("emailSuccess1").innerHTML = "Please Choose Physician Or Enter Email or Fax Number";
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<div class="input-group input-group-in">
														<span class="input-group-addon text-silver"><i
															class="glyphicon glyphicon-user"></i></span> <input type="text"
															id="fax" name="fax" class="form-control"
															placeholder="Fax Number" onkeyup="" />
					                                     
													</div>
													<div>  <span class="required" style="float: left; margin: 1.5% 0px 2% 0.6%; width: 550px;">Please only use a 10 digit number with no special characters. Example:1512999111</span></div>
								
<!-- 													<div id="emailSuccess3" style="display: none; color: #da4f49;"></div> -->
												</div>
											</div>
			...
			<div id="emailSuccess" style="display: none;margin-left:30%;color: #da4f49;"></div>
