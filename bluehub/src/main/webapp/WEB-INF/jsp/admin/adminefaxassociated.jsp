...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/admin/adminefaxassocoated.js"></script>
<script>
...
<div class="content-body">
		...
		<div id="panel-typeahead"
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">EFax Associated</h3>
			</div>
			...
			<div class="panel-body">
				...
				<input type="button" id="uploadbutton" class="btn btn-inverse"
					value="Un Associate" onclick="fnUnAssociateFaxDocuments()">
			</div>
