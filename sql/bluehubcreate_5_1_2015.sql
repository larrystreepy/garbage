...
(
  ...
  office_phone character varying(40),
  fax character varying(40),
  city character varying(50),
  zip character varying(15),
  signature character varying(10),
...
(
  ...
  updatedby integer,
  updatedon timestamp without time zone,
  uploadtype character varying(100),
  key character varying(100),
  keyid integer,
  receiveddate character varying(25),
  associateddate character varying(25),
...
(
  ...
  shareto integer,
  visitid integer,
  CONSTRAINT shareclinicalinfo_pkey PRIMARY KEY (id ),
  CONSTRAINT fk7eca3a062c05a0 FOREIGN KEY (visitid)
      REFERENCES visitinformation (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT fk7eca3a0b9c2354c FOREIGN KEY (shareto)
      REFERENCES userinformation (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION,
  CONSTRAINT fk7eca3a0e10db2bb FOREIGN KEY (sharefrom)
      REFERENCES userinformation (id) MATCH SIMPLE
      ON UPDATE NO ACTION ON DELETE NO ACTION
)
WITH (
